...
const getEmailHtml = (user, order, products) => {
  ...
  products.map((prod, index) => {
    items += `
       <tr>
          ...
          <td>
              <p style="font-weight: 500; font-family: 'Poppins','Google Sans',Roboto,sans-serif; font-size: 16px;">${
                prod.name
  ...
  return (
    ...
    <div style="font-family: 'Poppins','Google Sans',Roboto,sans-serif; margin:auto; width:fit-content;">
                ...
                <h1 style="color: #54605F;  font-weight: 600; font-size: 24px; margin-top: 30px;">Thanks for shopping, ${
                  user.fName
                }!</h1>
                <p style="color: black; font-size: 18px; font-weight: 500; margin-bottom: 0;">Your order was recieved</p>
                <p style="color: black; font-size: 15px; margin-bottom: 0; margin-top: 18px;">${new Date(
                  order.createdAt
                ).toLocaleString("en", {
                  year: "numeric",
                  month: "long",
